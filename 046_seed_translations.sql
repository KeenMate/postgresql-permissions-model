...
insert into public.translation (created_by, updated_by, language_code, data_group, data_object_code, context, value) values
    ...
    ('system', 'system', 'en', 'event_code', 'tenant_soft_deleted',     'title', 'Tenant Soft-Deleted'),
    ('system', 'system', 'en', 'event_code', 'tenant_soft_deleted',     'description', 'Tenant was soft-deleted (reversible)'),
    ('system', 'system', 'en', 'event_code', 'tenant_restored',         'title', 'Tenant Restored'),
    ('system', 'system', 'en', 'event_code', 'tenant_restored',         'description', 'Soft-deleted tenant was restored'),
    ('system', 'system', 'en', 'event_code', 'tenant_purged',           'title', 'Tenant Purged'),
    ('system', 'system', 'en', 'event_code', 'tenant_purged',           'description', 'Tenant was permanently purged'),
